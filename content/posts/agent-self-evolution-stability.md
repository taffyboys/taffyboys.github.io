...
- [[evaluation-of-self-evolving-agents]] — §7.1.2 Retention 评估目标
- [[future-directions]] — §8.3 安全可控的自进化
- [[how-to-evolve]] — §5.4-5.5 方法稳定性对比
- [[what-to-evolve]] — §3.4 架构进化稳定性
- [[self-evolving-agents-taxonomy]] — 分类体系总览
- [[community-and-news]] — 社区讨论与本主题交叉
- [[agent-self-evolution-stability]]（multimodal-backdoor 知识库）— 后门持久性专门分析
